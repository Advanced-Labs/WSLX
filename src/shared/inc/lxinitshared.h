...
// WSLX Fork: Ports offset by +1000 for SxS operation (canonical: 50000-50005)
//

#define LX_INIT_UTILITY_VM_INIT_PORT (51000)
#define LX_INIT_UTILITY_VM_PLAN9_PORT (51001)
#define LX_INIT_UTILITY_VM_PLAN9_DRVFS_PORT (51002)
#define LX_INIT_UTILITY_VM_PLAN9_DRVFS_ADMIN_PORT (51003)
#define LX_INIT_UTILITY_VM_VIRTIOFS_PORT (51004)
#define LX_INIT_UTILITY_VM_CRASH_DUMP_PORT (51005)
